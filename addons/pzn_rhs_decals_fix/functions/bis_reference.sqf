...
switch _mode do
{
	case "onLoad":
	{
		...
		private ["_shown","_display", "_colorHighlight", "_bullet", "_message", "_text1", "_text2", "_buttonSpoiler", "_textSpoiler",
		...
		if ((configName (configFile >> "CfgPatches" >> "A3_Missions_F_EPC")) != "") then 
		{
			...
			if (_shown <= 0) then 
			{
				...
				_message = _message + (localize "STR_A3_RSCDISPLAYWELCOME_PARB_FOOTER") + "<br /><br />";
				...
				_message = _message + (localize "STR_A3_RSCDISPLAYWELCOME_PARC_FOOTER") + "<br /><br />";
				...
				_message = _message + _bullet + " <t color='" + _colorHighlight + "'>" + (localize "STR_A3_RSCDISPLAYWELCOME_PARE_LIST3_TITLE") + "</t> - " + (localize "STR_A3_RSCDISPLAYWELCOME_PARE_LIST3") + "<br />";
				...
				_message = _message + _bullet + " <t color='" + _colorHighlight + "'>" + (localize "STR_A3_RSCDISPLAYWELCOME_PARE_LIST5_TITLE") + "</t> - " + (localize "STR_A3_RSCDISPLAYWELCOME_PARE_LIST5") + "<br /><br />";
			...
			else 
			{
				...
				_message = _message + (localize "STR_A3_RSCDISPLAYWELCOME_BOOT_PARB_FOOTER") + "<br /><br />";
				...
				_message = _message + (localize "STR_A3_RSCDISPLAYWELCOME_BOOT_PARD_FOOTER") + "<br /><br />";
