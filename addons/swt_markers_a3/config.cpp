// config.bin - 20:05:03 04/14/19, generated in 0.04 seconds
// Generated by unRap v1.06 by Kegetys
// Separate rootclasses: Disabled, Automatic comments: Enabled

class BIS_AddonInfo {
	author = "Liquid";
	timepacked = 1525814010;
};
...
class CfgMarkers {
	...
	class Flag;
	class b_unknown: Flag {scope = 1;};
	class o_unknown: b_unknown {scope = 2; shadow = 1;};
	class o_inf: o_unknown {scope = 2; shadow = 1;};
	class o_armor: o_unknown {scope = 2; shadow = 1;};
	class o_uav: o_unknown {scope = 2; shadow = 0;};
	class o_support: o_unknown {scope = 2; shadow = 0;};
	class o_service: o_unknown {scope = 2; shadow = 0;};
	class o_recon: o_unknown {scope = 2; shadow = 0;};
	class o_plane: o_unknown {scope = 2; shadow = 0;};
	class o_Ordnance: o_unknown {scope = 2; shadow = 0;};
	class o_naval: o_unknown {scope = 2; shadow = 0;};
	class o_motor_inf: o_unknown {scope = 2; shadow = 0;};
	class o_mortar: o_unknown {scope = 2; shadow = 0;};
	class o_med: o_unknown {scope = 2; shadow = 0;};
	class o_mech_inf: o_unknown {scope = 2; shadow = 0;};
	class o_maint: o_unknown {scope = 2; shadow = 0;};
	class o_installation: o_unknown {scope = 2; shadow = 0;};
	class o_art: o_unknown {scope = 2; shadow = 0;};
	class o_antiair: o_unknown {scope = 2; shadow = 0;};
	class o_air: o_unknown {scope = 2; shadow = 0;};
	class o_hq: o_unknown {scope = 2; shadow = 0;};
};
