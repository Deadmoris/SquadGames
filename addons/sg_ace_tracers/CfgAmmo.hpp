...
class CfgAmmo {
    ...
    //No idea
    class B_56x15_dual: BulletBase {model = PATHTOF(TracerWhite2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_white

    //Pistol
    class B_9x21_Ball: BulletBase {model = PATHTOF(TracerWhite2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_white
    class B_9x21_Ball_Tracer_Green: B_9x21_Ball {model = PATHTOF(TracerGreen2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_green
    class B_9x21_Ball_Tracer_Red: B_9x21_Ball_Tracer_Green {model = PATHTOF(TracerRed2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_red
    class B_9x21_Ball_Tracer_Yellow: B_9x21_Ball_Tracer_Green {model = PATHTOF(TracerYellow2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_yellow
    class Sub_F_Signal_Green: B_9x21_Ball {model = PATHTOF(TracerGreen2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_green
    class Sub_F_Signal_Red: Sub_F_Signal_Green {model = PATHTOF(TracerRed2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_red

    class B_45ACP_Ball: BulletBase {model = PATHTOF(TracerRed2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_red
    class B_45ACP_Ball_Green: B_45ACP_Ball {model = PATHTOF(TracerGreen2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_green
    class B_45ACP_Ball_Yellow: B_45ACP_Ball {model = PATHTOF(TracerYellow2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_yellow

    //Assault rifle

    class B_50BW_Ball_F: BulletBase {model = PATHTOF(sg_TracerGreen2.p3d);};

    class B_545x39_Ball_F: BulletBase {model = PATHTOF(TracerYellow2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_yellow
    class B_545x39_Ball_Green_F: B_545x39_Ball_F {model = PATHTOF(TracerGreen2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_yellow

    class B_556x45_Ball: BulletBase {model = PATHTOF(ace_TracerYellow2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_yellow
    class B_556x45_Ball_Tracer_Red: B_556x45_Ball {model = PATHTOF(TracerRed2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_red
    class B_556x45_Ball_Tracer_Green: B_556x45_Ball {model = PATHTOF(TracerGreen2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_green
    class B_556x45_Ball_Tracer_Yellow: B_556x45_Ball {model = PATHTOF(TracerYellow2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_yellow
    // class B_556x45_Ball_Tracer_White: B_556x45_Ball {model = PATHTOF(TracerWhite2.p3d);}; //New class for testing

    class B_580x42_Ball_F: BulletBase {model = PATHTOF(TracerGreen2.p3d);};
    class ACE_580x42_Ball_Tracer_Red: B_580x42_Ball_F {model = PATHTOF(TracerRed2.p3d);};
    class ACE_580x42_Ball_Tracer_Yellow: B_580x42_Ball_F {model = PATHTOF(TracerYellow2.p3d);};

    class B_65x39_Caseless: BulletBase {model = PATHTOF(TracerRed2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_red
    class B_65x39_Caseless_green: B_65x39_Caseless {model = PATHTOF(TracerGreen2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_green
    class B_65x39_Caseless_yellow: B_65x39_Caseless {model = PATHTOF(TracerYellow2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_yellow

    class B_65x39_Case;
    class B_65x39_Case_green: B_65x39_Case {model = PATHTOF(TracerGreen2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_green
    class B_65x39_Case_yellow: B_65x39_Case {model = PATHTOF(TracerYellow2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_yellow

    class B_65x39_Minigun_Caseless: SubmunitionBullet {model = PATHTOF(TracerRed2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_red
    class B_65x39_Minigun_Caseless_Red_splash;
    class B_65x39_Minigun_Caseless_Yellow_splash: B_65x39_Minigun_Caseless_Red_splash {model = PATHTOF(TracerYellow2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_yellow
    class B_65x39_Minigun_Caseless_Green_splash: B_65x39_Minigun_Caseless_Red_splash {model = PATHTOF(TracerGreen2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_green

    class B_762x39_Ball_F: BulletBase {model = PATHTOF(TracerYellow2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_yellow
    class B_762x39_Ball_Green_F: B_762x39_Ball_F {model = PATHTOF(TracerGreen2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_yellow

    //Battle rifle
    class B_762x51_Ball: BulletBase {model = PATHTOF(TracerWhite2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_white
    class B_762x51_Tracer_Red: B_762x51_Ball {model = PATHTOF(TracerRed2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_red
    class B_762x51_Tracer_Green: B_762x51_Ball {model = PATHTOF(TracerGreen2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_green
    class B_762x51_Tracer_Yellow: B_762x51_Ball {model = PATHTOF(TracerYellow2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_yellow

    class B_762x51_Minigun_Tracer_Red: SubmunitionBullet {model = PATHTOF(sg_TracerRed2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_red
    class B_762x51_Minigun_Tracer_Red_splash: B_762x51_Ball {model = PATHTOF(sg_TracerRed2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_red

    class B_762x51_Minigun_Tracer_Yellow: B_762x51_Minigun_Tracer_Red {model = PATHTOF(sg_TracerYellow2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_yellow
    class B_762x51_Minigun_Tracer_Yellow_splash: B_762x51_Minigun_Tracer_Red_splash {model = PATHTOF(sg_TracerYellow2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_yellow

    class B_762x54_Ball;
    class B_762x54_Tracer_Red: B_762x54_Ball {model = PATHTOF(TracerRed2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_red
    class B_762x54_Tracer_Green: B_762x54_Ball {model = PATHTOF(TracerGreen2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_green
    class B_762x54_Tracer_Yellow: B_762x54_Ball {model = PATHTOF(TracerYellow2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_yellow

    //Sniper rifle
    class B_127x99_Ball: BulletBase {model = PATHTOF(sg_TracerWhite2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_white
    class B_127x99_Ball_Tracer_Red: B_127x99_Ball {model = PATHTOF(sg_TracerRed2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_red
    class B_127x99_Ball_Tracer_Green: B_127x99_Ball {model = PATHTOF(sg_TracerGreen2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_green
    class B_127x99_Ball_Tracer_Yellow: B_127x99_Ball {model = PATHTOF(sg_TracerYellow2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_yellow

    class B_127x99_SLAP;
    class B_127x99_SLAP_Tracer_Red: B_127x99_SLAP {model = PATHTOF(sg_TracerRed2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_red
    class B_127x99_SLAP_Tracer_Green: B_127x99_SLAP {model = PATHTOF(sg_TracerGreen2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_green
    class B_127x99_SLAP_Tracer_Yellow: B_127x99_SLAP {model = PATHTOF(sg_TracerYellow2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_yellow

    class B_408_Ball: BulletBase {model = PATHTOF(sg_TracerGreen2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_green
    class B_127x33_Ball: BulletBase {model = PATHTOF(sg_TracerGreen2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_green

    class B_127x108_Ball: BulletBase {model = PATHTOF(sg_TracerGreen2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_green

    class B_338_Ball: BulletBase {model = PATHTOF(sg_TracerRed2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_red

    class B_338_NM_Ball: BulletBase {model = PATHTOF(sg_TracerRed2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_red
    class ACE_338_NM_Ball_red : B_338_NM_Ball {model = PATHTOF(sg_TracerRed2.p3d);};
    class ACE_338_NM_Ball_yellow : B_338_NM_Ball {model = PATHTOF(sg_TracerYellow2.p3d);};

    class B_127x54_Ball: BulletBase {model = PATHTOF(sg_TracerGreen2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_green

    class B_93x64_Ball: BulletBase {model = PATHTOF(sg_TracerGreen2.p3d);}; //Replaces \A3\Weapons_f\Data\bullettracer\tracer_green
    class ACE_93x64_Ball_tracer_red : B_93x64_Ball {model = PATHTOF(sg_TracerRed2.p3d);};
    class ACE_93x64_Ball_tracer_yellow : B_93x64_Ball {model = PATHTOF(sg_TracerYellow2.p3d);};
