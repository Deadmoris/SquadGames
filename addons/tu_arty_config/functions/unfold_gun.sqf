...
[30,2, _gun, TU_ARTY_GUN_INTERACTION_RANGE, [], {
	...
	if (_gun isKindOf "rhs_D30_base") then {
		[_gun,0] call rhs_fnc_d30_pack;
	} else {
		_gun animate ['fold_mainturret_counter_rotate',0];
		[_gun,0] call rhs_fnc_m119_fold;
	};
	_gun setVariable ["tu_arty_folded",false,true]},
{}, "Перевод гаубицы в боевое положение"] call tu_arty_fnc_collective_action;
