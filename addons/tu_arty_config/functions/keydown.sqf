...
if ((_this select 1) == 210) exitWith {[0,1,2,3,_this select 2,_this select 3,6,1] call tu_arty_fnc_optic_swing};
if ((_this select 1) == 211) exitWith {[0,1,2,3,_this select 2,_this select 3,6,-1] call tu_arty_fnc_optic_swing};
