...
if (_code in (actionKeys "MoveBack")) exitWith {
	...
	[2, [_gun], {_this call tu_arty_fnc_endshift;}, {((_this select 0) select 0) animate ['MainTurret_RotateFast', (((_this select 0) select 0) animationPhase 'MainTurret_RotateFast') + (random 200) - 100]; _this call tu_arty_fnc_endshift; hint 'Бросил как попало'}, "Установка двуноги"] call ace_common_fnc_progressBar;
};
