...
if (([_caller] call FUNC(isInRepairFacility)) || ([_target] call FUNC(isInRepairFacility))) then {_repairTime = _repairTime / 3};
if (([_caller] call FUNC(isNearRepairVehicle)) || ([_target] call FUNC(isNearRepairVehicle))) then {_repairTime = _repairTime / 1.5};
// Start repair
[
    _repairTime,
