...
class	Sounds
{
	...
	#define HZ_RPM1 FACTOR_RPM(600,1400)
	#define HZ_RPM2	FACTOR_RPM(1200,1600)
	#define HZ_RPM3 FACTOR_RPM(1300,1700)
	#define HZ_RPM4 FACTOR_RPM(1700,1950)
	...
	#define VOLUME_RPM2 FACTOR2_RPM(1300,1350,1550,1650)
	#define VOLUME_RPM3 FACTOR2_RPM(1600,1650,1750,1800)
	#define VOLUME_RPM4 FACTOR2_RPM(1750,1800,1920,1950)
