class CfgPatches
{
	class rwr_15_stn {
		...
		author = "ACE2 Team, Stolen, TECAK, reyhard";
...
class Extended_PreInit_EventHandlers {
	class rwr_15_stn {
		clientinit = "call ('\rwr_15_stn\preClientInit.sqf' call SLX_XEH_COMPILE)";
	};
};
...
class Extended_GetIn_EventHandlers {
	class Air {
		class rwr_15_stn {
			clientGetIn = "if (player == _this select 2) then {_this call rwr_15_stn_fnc_getIn;}";
...
class CfgVehicles {
	...
	class AllVehicles : All {
		threat_rwr_img = "rwr_15_stn\data\threat.paa";
	};
	...
	class RHS_Ka52_base: Heli_Attack_02_base_F {
		...
		rangerwrnew = 7100;
		rangerwrold = 8875;
		threat_rwr_img = "rwr_15_stn\data\threat_ka.paa";
		class ACE_SelfActions {
			class rwr_15 {
				displayName = "$STR_RWR";
				condition = "(ACE_player == driver vehicle ACE_player || ACE_player == gunner vehicle ACE_player)";
	...
	*/
	...
	class CUP_AV8B_Base: Plane {
		...
		rangerwrnew = 7100;
		rangerwrold = 8875;
		threat_rwr_img = "rwr_15_stn\data\threat_av.paa";
		class ACE_SelfActions {
			class rwr_15 {
				displayName = "$STR_RWR";
				condition = "(ACE_player == driver vehicle ACE_player || ACE_player == gunner vehicle ACE_player)";
	...
	*/
	...
	class RHS_A10 : Plane_CAS_01_base_F {
		has_rwr = 1;
		type_rwr = 2;
		threat_rwr_img = "rwr_15_stn\data\threat_10.paa";
		class ACE_SelfActions {
			class rwr_15 {
				displayName = "$STR_RWR";
				condition = "(ACE_player == driver vehicle ACE_player || ACE_player == gunner vehicle ACE_player)";
	...
	class rhs_mig29s_base: Plane_Base_F {
	    rangerwrnew = 10100;
		rangerwrold = 12625;
		threat_rwr_img = "rwr_15_stn\data\threat_29.paa";
	};	
	...
	*/
	...
	class RHS_AH64_base : Heli_Attack_01_base_F {
		...
		rangerwrnew = 6100;
		rangerwrold = 7625;
		threat_rwr_img = "rwr_15_stn\data\threat_ah.paa";
		class ACE_SelfActions {
			class rwr_15 {
				displayName = "$STR_RWR";
				condition = "(ACE_player == driver vehicle ACE_player || ACE_player == gunner vehicle ACE_player)";
	...
	class rhs_zsutank_base : APC_Tracked_02_base_F {
		threat_rwr_img = "rwr_15_stn\data\threat_23.paa";
		rangerwrnew = 5100;
		rangerwrold = 6375;
	};
	...
	class Tank_F;
	/*
	class CUP_2S6M_Base: Tank_F {
		threat_rwr_img = "rwr_15_stn\data\threat_s6.paa";
		rangerwrnew = 10100;
		rangerwrold = 12625;
	};
	...
	*/
	...
	class CUP_M163_Base: CUP_M113_Base {
		threat_rwr_img = "rwr_15_stn\data\threat_vu.paa";
		rangerwrnew = 5100;
		rangerwrold = 6375;
	};
	*/
	...
	class Redd_Tank_Gepard_1A2_base: Tank_F {
		threat_rwr_img = "rwr_15_stn\data\threat_gp.paa";
		rangerwrnew = 5100;
		rangerwrold = 6375;
	};
	*/
	...
	class rhsusf_f22: Plane_Fighter_03_base_F {
		...
		rangerwrnew = 5100;
		rangerwrold = 6375;
		threat_rwr_img = "rwr_15_stn\data\threat_22.paa";
		class ACE_SelfActions {
			class rwr_15 {
				displayName = "$STR_RWR";
				condition = "(ACE_player == driver vehicle ACE_player || ACE_player == gunner vehicle ACE_player)";
	...
	class FIR_F16D_Base : Plane_Fighter_03_base_F {
		...
		rangerwrnew = 8100;
		rangerwrold = 10125;
		threat_rwr_img = "rwr_15_stn\data\threat_16.paa";
		class ACE_SelfActions {
			class rwr_15 {
				displayName = "$STR_RWR";
				condition = "(ACE_player == driver vehicle ACE_player || ACE_player == gunner vehicle ACE_player)";
	...
	class JS_JC_FA18E : Plane {
		...
		rangerwrnew = 10100;
		rangerwrold = 12625;
		threat_rwr_img = "rwr_15_stn\data\threat_18.paa";
		class ACE_SelfActions {
			class rwr_15 {
				displayName = "$STR_RWR";
				condition = "(ACE_player == driver vehicle ACE_player || ACE_player == gunner vehicle ACE_player)";
	...
	class CUP_SU34_BASE : Plane {
		...
		rangerwrnew = 10100;
		rangerwrold = 12625;
		threat_rwr_img = "rwr_15_stn\data\threat_34.paa";
		class ACE_SelfActions {
			class rwr_15 {
				displayName = "$STR_RWR";
				condition = "(ACE_player == driver vehicle ACE_player || ACE_player == gunner vehicle ACE_player)";
	...
	class JS_JC_SU35 : Plane {
		rangerwrnew = 11100;
		rangerwrold = 13875;
		threat_rwr_img = "rwr_15_stn\data\threat_35.paa";
	};
	*/
};
	...
	class ACE_RWR_RU {
		...
		class controlsBackground {
			...
			class BackGround: ACE_RWR_RscPicture {
				...
				colorBackground[] = {0, 0, 0, 0};
				text = "\rwr_15_stn\data\rwr_spo.paa";
			};
		...
		class controls {
			...
			class ACE_RWR_SPO_90LB: ACE_RWR_SPOMainThreat {
				...
				text = "\rwr_15_stn\data\threat_primary_dir_act90S.paa";
			};

			class ACE_RWR_SPO_90RB: ACE_RWR_SPO_90LB {
				idc = 22000+ 29;
				x = 0.96148 * safezoneW + safezoneX;
				text = "\rwr_15_stn\data\threat_primary_dir_act90B.paa";
			};
			...
			class ACE_RWR_SPO_ST1: ACE_RWR_SPOSecondaryThreatType {
				...
				text = "\rwr_15_stn\data\threat_n.paa";
			};

			class ACE_RWR_SPO_ST2: ACE_RWR_SPO_ST1 {
				idc = 22000+ 23;
				x = 0.921811 * SafeZoneW + SafeZoneX;
				text = "\rwr_15_stn\data\threat_3.paa";
			};

			class ACE_RWR_SPO_ST3: ACE_RWR_SPO_ST1 {
				idc = 22000+ 24;
				x = 0.933976 * SafeZoneW + SafeZoneX;
				text = "\rwr_15_stn\data\threat_x.paa";
			};

			class ACE_RWR_SPO_ST4: ACE_RWR_SPO_ST1 {
				idc = 22000+ 25;
				x = 0.945612 * SafeZoneW + SafeZoneX;
				text = "\rwr_15_stn\data\threat_h.paa";
			};

			class ACE_RWR_SPO_ST5: ACE_RWR_SPO_ST1 {
				idc = 22000+ 26;
				x = 0.958307 * SafeZoneW + SafeZoneX;
				text = "\rwr_15_stn\data\threat_f.paa";
			};

			class ACE_RWR_SPO_ST6: ACE_RWR_SPO_ST1 {
				idc = 22000+ 27;
				x = 0.970472 * SafeZoneW + SafeZoneX;
				text = "\rwr_15_stn\data\threat_c.paa";
			};
			...
			class ACE_RWR_SPO_SignalUp: ACE_RWR_RscPicture {
				idc = 22000+ 34;
				text = "\rwr_15_stn\data\threat_up.paa";
				x = 0.894564 * SafeZoneW + SafeZoneX;
				y = 0.671654 * SafeZoneH + SafeZoneY - 0.42;
				w = 0.100852 * SafeZoneW;
				h = 0.322844 * SafeZoneH;
			...
			class ACE_RWR_SPO_SignalDown: ACE_RWR_RscPicture {
				idc = 22000+ 35;
				text = "\rwr_15_stn\data\threat_down.paa";
				x = 0.894564 * SafeZoneW + SafeZoneX;
				y = 0.671654 * SafeZoneH + SafeZoneY - 0.42;
				w = 0.100852 * SafeZoneW;
				h = 0.322844 * SafeZoneH;
	...
	class ACE_RWR_US {
		...
		class controlsBackground {
			...
			class BackGround: ACE_RWR_RscPicture {
				...
				h = 0.293400;
				colorBackground[] = {0, 0, 0, 0};
				text = "\rwr_15_stn\data\rwr_default.paa";
			};
		};
...
class CfgSounds {
	class ACE_RWR15_TRACK {
		...
		sound[] = {"\rwr_15_stn\sound\SPOTrack.ogg", db+4, 1};
		titles[] = {};
	};

	class ACE_RWR15_IR {
		name = "ACE_RWR15_IR";
		sound[] = {"\rwr_15_stn\sound\SPOIR.ogg", db+4, 1};
		titles[] = {};
	};
	
	class ACE_SR5RWR_AIR {
		name = "ACE_SR5RWR_AIR";
		sound[] = {"\rwr_15_stn\sound\SR5RWR_AIR.ogg", 1, 1};
		titles[] = {};
	};
	
	class ACE_SR5RWR_GROUND {
		name = "ACE_SR5RWR_GROUND";
		sound[] = {"\rwr_15_stn\sound\SR5RWR_GROUND.ogg", 1, 1};
		titles[] = {};
	};
	
	class ACE_SR5RWR_IR {
		name = "ACE_SR5RWR_IR";
		sound[] = {"\rwr_15_stn\sound\SR5RWR_IR.ogg", 1, 1};
		titles[] = {};
	};
	
	class rwr_beep_long {
		name = "rwr_beep_long";
		sound[] = {"\rwr_15_stn\sound\Untitled.ogg", 0.8, 1};
		titles[] = {};
	};
};
